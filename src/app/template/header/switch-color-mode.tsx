    ...
    >
      ...
      >
        <Text
          ...
          transform={isMoon ? 'translate3d(10px, 0, 0) rotate(28deg)' : 'rotate(-45deg)'}
          boxShadow={isMoon ? `-8px 10px 0px 0px ${moonColor}` : `0px 0px 4px ${sunColor}`}
          _hover={{
            transform: isMoon ? 'scale3d(-1, -1, -1)' : 'scale(0.77)',
            transition: isMoon ? 'all 50s ease-out' : 'all 1.3s ease-out',
            boxShadow: isMoon ? `0 0 70px ${moonShadow}` : `1px 0px 22px ${sunColor}`,
            textShadow: isMoon ? `0 0 70px ${moonShadow}` : `0 0 80px ${sunShadow}`
          }}
        />
        <Text
          as={motion.span}
