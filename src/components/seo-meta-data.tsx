...
type SeoProps = Pick<Content.HomeDocumentData, 'seoTitle' | 'seoDescription' | 'imagePreview'>

export const SeoMetaData = ({ seoTitle, imagePreview, seoDescription }: SeoProps) => {
  return (
    <Head>
