...
export const InputsFeedbacks = ({ lang, cookieFeedbackId }: InputsFeedbacksProps) => {
  ...
  const emojisData: EmojisType[] = ['terrible', 'bad', 'regular', 'good', 'excellent']
  ...
  function handleEmoji(emojiSelect: EmojisType[]) {
    ...
    if (emojiSelect.length === 1) return setValue('feedbackLevel', emojiSelect[0])
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FormErrorMessage>{errors.feedbackLevel && errors.feedbackLevel.message}</FormErrorMessage>
      </FormControl>
