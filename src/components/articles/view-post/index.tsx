...
export const ViewPost = ({postData}: ViewPostProps) => {
	...
	return (
		<VStack
			...
			<HStack w="100%" justify="center" align="start" spacing={12}>
				<Text>
					Total de feedbacks do post:
					<Text as="span" pl={2} color="red">
						20
					</Text>
				</Text>
				<VStack>
					<Text>Quão satisfeito você está com esse post? </Text>
