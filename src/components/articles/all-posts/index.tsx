...
import { Box, Link, Flex, Text, Stack, VStack, Heading } from '@chakra-ui/react'

export type PostDataProps = Pick<InferGetServerSidePropsType<typeof getStaticProps>, 'postData'>
