...
import { TabReports, TabReportsPainel, AllReportsInFeedbackType } from './tab-reports'
import { TabFeedbacks, TabFeedbacksPainel, FeedbackListOfPostsTypes } from './tab-feedbacks'
