...
import { Icon, VStack, Button, SimpleGrid, AbsoluteCenter } from '@chakra-ui/react'
...
export const ReadMore = ({ children, lang }: ReadMoreProps) => {
  ...
  return (
    <VStack spacing="14" align="center">
      <SimpleGrid columns={{ base: 1, lg: 2 }} justifyItems="center" spacing={4}>
      ...
      >
        ...
        >
          {isReadMore ? <Icon boxSize={7} as={FaAngleDown} /> : <Icon boxSize={7} as={FaAngleUp} />}
        </AbsoluteCenter>
      </Button>
    </VStack>
  )
