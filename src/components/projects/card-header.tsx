...
export const CardHeader = ({ title, githubLink, deployLink, lang }: TitleProps) => {
  const [sunShadow, moonShadow] = useToken('colors', ['gbdx.sunShadow', 'gbdx.moonShadow'])
  ...
  return (
    <Flex w="full" justify="space-between">
      <HStack w="274px" overflow="hidden">
        <Icon as={FiZap} boxSize=".9em" mt="1px" color="yellow.400" _light={{ color: 'yellow' }} />
